...
############################################################################
########### for sampling by train with zurich ##############################

def rgb2rawhr(image, image_processing_params, meta_info):
    # Sample camera pipeline params
    rgb2cam = meta_info['cam2rgb'][0]

    # Sample gains
    rgb_gain, red_gain, blue_gain = meta_info['rgb_gain'], meta_info['red_gain'], meta_info['blue_gain']
