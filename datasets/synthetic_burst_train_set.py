...
class SyntheticBurst(torch.utils.data.Dataset):
    ...
    """
    def __init__(self, base_dataset, burst_size=8, crop_sz=384, transform=tfm.ToTensor(), use_fp16=False):
    ...
    def __getitem__(self, index):
        ...
        meta_info['burst_name'] = '{:04d}'.format(index)
        ...
        return burst, frame_gt_rgb, flow_vectors, meta_info
